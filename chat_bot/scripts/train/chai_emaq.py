...
if __name__ == "__main__":
    ...
    parser.add_argument("--logdir", type=str, default="./logs/chai", required=True)
    parser.add_argument("--filepath", type=str, default="./data/train.json", required=True)
    parser.add_argument("--embeddings", type=str, default="embeddings.pkl", required=True)
    parser.add_argument("--sentences", type=str, default="sentences.pkl", required=True)
